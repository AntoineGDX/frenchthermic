// FRENCH THERMIC — homepage hero
const { Button: HBtn, Badge: HBadge, DpeBadge: HDpeBadge } = window.FrenchThermic_dd06d0;
      ...
      <div style={{
        ...
        <div>
          ...
          <p style={{ font: '18px/1.6 var(--font-sans)', color: 'rgba(255,255,255,0.78)', margin: '22px 0 0', maxWidth: 520 }}>
            Chauffage, rafraîchissement et performance énergétique pour les logements où l’on ne peut pas — ou ne veut pas — poser de groupe extérieur. Étude, installation et suivi par une équipe certifiée RGE.
          </p>
          <div style={{ display: 'flex', gap: 14, marginTop: 34, flexWrap: 'wrap' }}>
            <HBtn variant="accent" size="lg" onClick={() => { window.location.href = '#contact'; }} iconRight={<span data-ico="ArrowRight" />}>Demander un devis gratuit</HBtn>
            <HBtn variant="secondary" size="lg" onClick={() => { window.location.href = 'expertise/'; }} style={{ background: 'transparent', color: '#fff', borderColor: 'rgba(255,255,255,0.3)' }}>Découvrir l’expertise</HBtn>
          </div>
        ...
        <div style={{
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: 14, margin: '20px 0' }}>
            <HDpeBadge grade="F" size="lg" label="Avant" />
            <span data-ico="ArrowRight" style={{ color: 'rgba(255,255,255,0.5)' }} />
            <HDpeBadge grade="B" size="lg" label="Après" />
          </div>
